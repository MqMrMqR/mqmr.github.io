...
function changeInstall(e) {
    ...
    "ios" == e ? document.getElementById("pillSelectorPill").style.left = "0%" : "windows" == e ? document.getElementById("pillSelectorPill").style.left = "50%" : "unity" == e ? document.getElementById("pillSelectorPill").style.left = "25%" : "linux" == e && (document.getElementById("pillSelectorPill").style.left = "75%");
    var t = document.getElementsByClassName("installInfo");
    for (i = 0; i < t.length; i++)
        t[i].style.display = "none";
    document.getElementById(e + "Guide").style.display = "block"
}
function changeIpswInstall(e) {
    e = e.innerText.toLowerCase();
    "windows" == e ? document.getElementById("pillSelectorPill2").style.left = "50%" : "unity" == e && (document.getElementById("pillSelectorPill2").style.left = "0%");
    var t = document.getElementsByClassName("ipswInstallInfo");
    for (i = 0; i < t.length; i++)
        t[i].style.display = "none";
    document.getElementById(e + "IpswGuide").style.display = "block"
}
...
loadFile("releases.json", function(e) {
    var t = JSON.parse(e)[0];
    oldRelease = JSON.parse(e);
    e = t.browser_download_url,
    window.navigator.userAgent;
    document.getElementById("latestDownloadURL").href = e,
    document.getElementById("altStoreLink").href = "altstore://install?url=https://unc0ver.dev" + e,
    document.getElementById("latestButton").innerText = "Download " + t.tag_name,
    6 <= t.tag_name.replace(/[a-z]/g, "").split(".")[0] && (document.getElementById("comingSoon").style.display = "none",
    document.getElementById("comingSoonMsg").innerText = "Now available with iOS 14.3 Support");
    e = t.body,
    t = new showdown.Converter;
    document.getElementById("changelogText").innerHTML = t.makeHtml(e.replace(/^((?!^- .*).)*$/gm, ""))
});
...
function getOldReleases(e) {
    for (i = e.length - 1; -1 < i; i--) {
        ...
        d.innerText = new Date(t.published_at).toLocaleDateString(),
        n.appendChild(d);
        o = createElement("div", "button");
        o.innerText = "Download";
        d = createElement("a");
        d.href = t.browser_download_url,
        d.appendChild(o),
        n.appendChild(d);
        var l, d = new showdown.Converter;
        n.innerHTML += d.makeHtml(t.body.replace(/^((?!^- .*).)*$/gm, ""));
        try {
            1 < n.getElementsByTagName("ul")[0].childElementCount && ((l = createElement("div", "viewMoreButton")).setAttribute("onClick", "expandChangelog(this)"),
            l.innerText = "more",
            n.appendChild(l))
        } catch (e) {}
...
function updateProgessBar(e) {
    ...
    document.getElementById("currentProgress").innerText += " (" + e + "%)"
}
...
function expandChangelog(e) {
    "more" == e.innerText ? e.innerText = "less" : e.innerText = "more",
...
function viewLegacyVersions() {
    ...
    "View Previous Versions" == viewLegacyVersionsButton.innerText ? (loadedOldReleases || getOldReleases(oldRelease),
    document.getElementById("legacyReleases").style.display = "inline",
    viewLegacyVersionsButton.innerText = "Hide Previous Versions") : (document.getElementById("legacyReleases").style.display = "none",
    viewLegacyVersionsButton.innerText = "View Previous Versions")
}
function viewTested() {
    var e = document.getElementById("viewTested");
    "View Tested Devices" == e.innerText ? (document.getElementById("testedDevicesList").style.display = "inline",
    e.innerText = "Hide Tested Devices") : (document.getElementById("testedDevicesList").style.display = "none",
    e.innerText = "View Tested Devices")
}
...
var animateHTML = function() {
    var t, n;
    function e() {
        t = document.querySelectorAll(".hidden"),
...
function readCookie(e) {
    for (var t = e + "=", n = document.cookie.split(";"), o = 0; o < n.length; o++) {
        for (var d = n[o]; " " == d.charAt(0); )
            d = d.substring(1, d.length);
        if (0 == d.indexOf(t))
            return "true" == d.substring(t.length, d.length) || "false" != d.substring(t.length, d.length) && d.substring(t.length, d.length)
    }
    return null
}
function createCookie(e, t, n) {
    var o;
    o = n ? ((o = new Date).setTime(o.getTime() + 24 * n * 60 * 60 * 1e3),
...
function ipswMore() {
    document.getElementById("ipswMoreBtn").classList.toggle("hideMore"),
    document.getElementById("ipswViewMore").classList.toggle("expanded")
}
betaDeviceChange();
